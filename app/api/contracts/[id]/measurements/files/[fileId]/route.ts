...
import { canDeleteMeasurementFile } from '@/lib/auth/fileAuth'
import { logMeasurementFileDelete } from '@/lib/services/auditLogger'
...
export async function DELETE(
  ...
  try {
    ...
    const hasPermission = await canDeleteMeasurementFile(
      authResult.user.id,
    ...
    // Log the deletion
    await logMeasurementFileDelete(
      contractId,
      fileId,
      authResult.user.id,
      file.filename,
